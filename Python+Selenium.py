...
# Test Script:
open_browser(url="https://www.aircanada.com/en-ca/great-fares-canada")
start_city(keyword="Tor", start_airport='Toronto-Pearson')
destination_city(shortword="sha", des_airport='PVG Pudong Int')
date(pick_date='Sat Apr 17, 2021')
tickets(tickets_number=3, age='age1')
close_browser(title="Air Canada - Select flights")
